...
public class AddDatasourceResponseListener extends BasicMessageListener<AddDatasourceResponse> {

    private ConnectedUIClients connectedUIClients;

    public AddDatasourceResponseListener(ConnectedUIClients connectedUIClients) {
        this.connectedUIClients = connectedUIClients;
    }

    protected void onBasicMessage(BasicMessageWithExtraData<AddDatasourceResponse> responseWithData) {
        try {
            AddDatasourceResponse response = responseWithData.getBasicMessage();
            ...
            MsgLogger.LOG.errorf(e, "Cannot process AddDatasourceResponse message");
        }
    }
}
